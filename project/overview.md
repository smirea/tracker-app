...
1. interactions
	...
	- [ ] tags. store and autosuggest for each as they get created (example "started taking trazodone" or "traveled on a plane")
		- [ ] show list of existing tags (sorted by name)
		- [ ] allow create new tags (typing filters list)
